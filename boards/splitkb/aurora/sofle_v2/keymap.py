...
FO9 = KC.LALT(KC.N9)
FO0 = KC.LALT(KC.N0)
MWSL= KC.LALT(KC.LSFT(KC.A))
MWSR= KC.LALT(KC.LSFT(KC.F))
I3CLS= KC.LALT(KC.LSFT(KC.Q))
I3MVR= KC.LALT(KC.LSFT(KC.L))
I3MVL= KC.LALT(KC.LSFT(KC.H))
I3MVU= KC.LALT(KC.LSFT(KC.K))
I3MVD= KC.LALT(KC.LSFT(KC.J))
...
KEYMAP_FERRIS = [
    ...
    [  # 7 ALWAYS AVAILABLE
        ...
        XXXXXXX, _______, KC.PERC, KC.SLSH, KC.ENT , KC.MINS,                       KC.DF(1), KC.LGUI, KC.RSFT, M_POINT, _______, XXXXXXX,
